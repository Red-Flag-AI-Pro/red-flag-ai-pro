        ...
        <div style={{maxWidth: "1100px", margin: "0 auto", width: "100%", textAlign: "center", position: "relative", zIndex: 1}}>
          ...
          <div className="hero-eyebrow animate-fade-in delay-1" style={{marginBottom: "2rem"}}>
            <span style={{
              ...
              <span className="hero-eyebrow-text-full">Marketing Compliance · 9 Jurisdictions · 29 Risk Categories</span>
              <span className="hero-eyebrow-text-short">9 Jurisdictions · 29 Risk Categories</span>
            </span>
          </div>
          ...
          <p className="hero-subheadline" style={{
            ...
            <span style={{color: "rgba(255,255,255,0.8)"}}>29 risk categories. 9 jurisdictions.</span>
            <br />
