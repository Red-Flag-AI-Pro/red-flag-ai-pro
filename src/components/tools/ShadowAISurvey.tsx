...
export function ShadowAISurvey() {
  ...
  return (
    <div>
      ...
      {result && (
        <ResultsGate tool="shadow-ai-survey" title="Enter your email to see your Shadow AI Exposure Score — free, plus occasional updates, unsubscribe anytime.">
          <div style={{ marginTop: "3rem" }}>
            <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
              <p style={{ ...syne, fontSize: "11px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: "0.5rem" }}>Shadow AI Exposure Score</p>
            ...
            {result.flags.length === 0 ? (
              <div style={{ background: "rgba(34,197,94,0.06)", border: "1px solid rgba(34,197,94,0.2)", borderRadius: "10px", padding: "2rem", textAlign: "center" }}>
                <p style={{ ...syne, fontSize: "14px", fontWeight: 700, color: "#22c55e" }}>Strong shadow AI controls — no major gaps flagged.</p>
              </div>
            ) : (
            ...
            <div style={{ marginTop: "2.5rem", textAlign: "center" }}>
              <p style={{ ...syne, fontSize: "12px", color: "rgba(255,255,255,0.3)", marginBottom: "1rem" }}>
                Over half of employees already use AI at work — under 40% of companies have a policy covering it. This is a quick self-check, not a full shadow AI audit.
              </p>
