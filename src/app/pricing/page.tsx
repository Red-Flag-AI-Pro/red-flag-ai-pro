      ...
      <div className="mx-auto max-w-7xl px-4 py-10">
        ...
        <div className="text-center mb-3">
          ...
          <p className="mt-2 text-gray-500 text-sm">
            ...
            <Link href="/#demo" className="text-red-400 hover:text-red-300 transition-colors font-medium">
              Run a free scan →
            </Link>
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-4 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="relative flex flex-col rounded-2xl border border-red-500 p-6 shadow-xl shadow-red-500/10" style={{ background: "linear-gradient(160deg, #1a0a0a 0%, #0f0810 100%)" }}>
            ...
            <Link
              ...
              className="mt-6 block rounded-xl bg-white py-2.5 text-center text-sm font-semibold text-red-600 hover:bg-red-50 transition-colors"
            >
              Get started →
            </Link>
          </div>
          ...
          {/* Growth */}
          <div className="relative flex flex-col rounded-2xl border border-gray-800 bg-gray-900/40 p-6">
            <h2 className="text-lg font-bold text-white">Growth</h2>
            <p className="mt-1 text-xs text-gray-500 leading-relaxed">
              For affiliate marketers and high-volume creators.
            </p>
            <div className="mt-3 flex items-baseline gap-1">
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-0 rounded-2xl" style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.2) 0%, transparent 40%)" }} />

            <div className="relative flex items-center gap-2 mb-1">
              <div className="h-1.5 w-1.5 rounded-full bg-red-600 animate-pulse" />
              <span className="text-xs font-bold uppercase tracking-widest text-gray-700">For agencies</span>
            </div>
            <h2 className="relative text-lg font-bold text-gray-900">Sentinel</h2>
            <p className="relative mt-1 text-xs text-gray-600 leading-relaxed">
            ...
            <Link
              href="/sentinel"
              className="relative mt-6 block rounded-xl py-2.5 text-center text-sm font-semibold transition-all hover:opacity-90"
