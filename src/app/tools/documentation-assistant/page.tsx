...
import { DocumentationAssistant } from "@/components/tools/DocumentationAssistant";
import React from "react";

export const metadata: Metadata = {
  title: "Free AI System Documentation Assistant | Red Flag AI Pro",
  description:
    "Answer a few questions about your AI system and get a technical documentation draft, following the structure of EU AI Act Annex IV. A documentation assistant, not a conformity assessment, free.",
  alternates: { canonical: "https://www.redflagaipro.com/tools/documentation-assistant" },
};
      ...
      <section style={{
        ...
        <div style={{ maxWidth: "640px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ ...syne, fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 800, color: "white", letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: "1rem" }}>
            AI system documentation<br />assistant
          </h1>
          <p style={{ ...syne, fontSize: "14px", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, maxWidth: "520px", margin: "0 auto" }}>
            Answer a few questions about your AI system and get a documentation draft, structured the way EU AI Act Annex IV expects. Free.
          </p>
        </div>
      </section>
