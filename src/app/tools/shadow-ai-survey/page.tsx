...
export const metadata: Metadata = {
  title: "Free Shadow AI Risk Survey — Find Out What Your Employees Aren't Telling IT | Red Flag AI Pro",
  description: "Over half of employees already use AI at work — under 40% of companies have a policy covering it. Answer 7 questions and get your Shadow AI Exposure Score. Free.",
      ...
      <section style={{ padding: "8rem 1.5rem 3rem", textAlign: "center", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: "640px", margin: "0 auto" }}>
          ...
          <h1 className="font-display" style={{ fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 500, color: "#F4F1EA", letterSpacing: "-0.015em", lineHeight: 1.12, marginBottom: "1rem" }}>
            Shadow AI Risk <span style={{ fontStyle: "italic", color: "#E5484D" }}>Survey</span>
          </h1>
          <p style={{ ...syne, fontSize: "14px", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, maxWidth: "520px", margin: "0 auto" }}>
            Over half of employees already use AI tools at work. Under 40% of companies have a policy covering it. Answer 7 quick questions and find out where you stand.
          </p>
        </div>
      </section>
