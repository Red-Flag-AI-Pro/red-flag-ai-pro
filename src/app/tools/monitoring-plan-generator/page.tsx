...
import { MonitoringPlanGenerator } from "@/components/tools/MonitoringPlanGenerator";
import React from "react";

export const metadata: Metadata = {
  title: "Free Post-Market Monitoring Plan Generator | Red Flag AI Pro",
  description:
    "Answer a few questions and draft a post-market monitoring plan for your AI system, covering metrics, thresholds and review cadence per EU AI Act Article 72. Free.",
  alternates: { canonical: "https://www.redflagaipro.com/tools/monitoring-plan-generator" },
};

const syne = { fontFamily: "'Syne', system-ui, sans-serif" } as React.CSSProperties;

export default function MonitoringPlanGeneratorPage() {
  return (
      ...
      <section style={{ padding: "8rem 1.5rem 3rem", textAlign: "center", borderBottom: "1px solid rgba(255,255,255,0.05)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "640px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ ...syne, fontSize: "clamp(2rem, 5vw, 3rem)", fontWeight: 800, color: "white", letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: "1rem" }}>
            Post-market monitoring<br />plan generator
          </h1>
          <p style={{ ...syne, fontSize: "14px", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, maxWidth: "520px", margin: "0 auto" }}>
            Answer a few questions and draft the plan Article 72 requires. This is the plan, not the live monitoring itself. Free.
          </p>
        </div>
      </section>
      <section style={{ padding: "4rem 1.5rem 6rem" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto" }}>
          <MonitoringPlanGenerator />
        </div>
      </section>
      <Footer />
    </div>
