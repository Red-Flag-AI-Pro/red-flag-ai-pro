          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              {[
                ...
                ["Scanner Plan", "£149/month (subject to change, existing subscribers grandfathered at their original rate). Billed monthly via Stripe."],
                ["Pro Plan", "£499/month (subject to change, existing subscribers grandfathered at their original rate). Billed monthly via Stripe."],
