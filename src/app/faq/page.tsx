...
const FAQS = [
  ...
  { category: "For sellers", q: "Can I scan YouTube VSLs?", a: "Yes. Paste a YouTube URL and we automatically fetch the transcript. You can also upload audio files for Whisper transcription. Both are then scanned against all 30 categories." },
  ...
  { category: "Pricing", q: "What is included in the free plan?", a: "One scan per month, access to 16 of our 30 risk categories across 9 jurisdictions, plus the full compliance toolkit (calculators and tools) inside your dashboard." },
