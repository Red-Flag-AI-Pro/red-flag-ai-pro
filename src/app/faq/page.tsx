...
const FAQS = [
  ...
  { category: "For sellers", q: "Which jurisdictions do you cover?", a: "USA (FTC, FDA, CAN SPAM), UK (CMA, ASA, FCA, ICO), EU (GDPR, EU AI Act, DSA), Australia (ACCC, TGA), Canada (CASL, PIPEDA), Brazil (LGPD), India (DPDP Act), Singapore (PDPA), UAE (PDPL 2022) and Nigeria (NDPR). 10 jurisdictions covered in every check." },
  ...
  { category: "Pricing", q: "What is included in the free plan?", a: "One check per month, access to 16 of our 30 risk categories across 10 jurisdictions, plus the full compliance toolkit (calculators and tools) inside your dashboard." },
  ...
  { category: "AI governance", q: "Is the governance assessment free?", a: "Yes. One assessment per email, no credit card required. Your score, top gaps and roadmap appear on screen instantly, with a summary sent to your inbox." },
];
