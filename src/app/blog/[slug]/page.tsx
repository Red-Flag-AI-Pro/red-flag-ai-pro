    ...
    <div style={{ background: "#050505", minHeight: "100vh" }}>
      ...
      <article style={{ maxWidth: "760px", margin: "0 auto", padding: "5rem 1.5rem" }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontFamily: "'Syne', system-ui, sans-serif", fontSize: "1.5rem", fontWeight: 800, color: "white", letterSpacing: "-0.02em", marginBottom: "0.75rem" }}>
          ...
          <p style={{ fontFamily: "'Syne', system-ui, sans-serif", fontSize: "13px", color: "rgba(255,255,255,0.4)", lineHeight: 1.7, marginBottom: "1.75rem" }}>
            Red Flag AI Pro checks your marketing copy against 26 risk categories across 8 jurisdictions in 60 seconds.
          </p>
