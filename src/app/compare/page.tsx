...
const COMPARISON = [
  { feature: "Price per month", rfp: "£29 – £499", redmarker: "£2,000 – £10,000", consultant: "£500 – £3,000" },
            ...
            <thead>
              <tr style={{ borderBottom: "2px solid rgba(255,255,255,0.08)" }}>
                ...
                <th style={{ padding: "1rem", textAlign: "center", background: "rgba(204,0,0,0.05)", borderLeft: "1px solid rgba(239,68,68,0.15)", borderRight: "1px solid rgba(239,68,68,0.15)" }}>
                  ...
                  <p style={{ ...syne, fontSize: "11px", color: "rgba(255,255,255,0.3)", marginTop: "2px" }}>£29–£499/mo</p>
                </th>
