...
function TryToBreakIt() {
  ...
  return (
    <section style={{ padding: "3rem 1.5rem 5rem", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        <p style={{ ...syne, fontSize: "0.85rem", color: "rgba(244,241,234,0.55)", lineHeight: 1.7, marginBottom: "1.25rem" }}>
          Seal the sample record below, then edit anything, one character is enough, and watch the fingerprint stop matching. This runs entirely in your browser. Nothing here is sent anywhere or stored. Tampering isn&apos;t made impossible, it&apos;s made detectable, and this is what detecting it actually looks like.
        </p>
        ...
        <textarea
          ...
          style={{
            ...
            resize: "vertical", marginBottom: "0.9rem",
          }}
        />
