...
export const metadata: Metadata = {
  ...
  description: "AI governance evidence for the SMB/mid-market segment enterprise tools ignore. The pitch, the market timing, and the real numbers, in one place.",
  ...
  return (
    <div style={{ background: "#0A1628", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "8rem 1.5rem 3rem", textAlign: "center", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: "780px", margin: "0 auto" }}>
          ...
          <h1 className="font-display" style={{ fontSize: "clamp(2rem, 5vw, 3.1rem)", fontWeight: 500, color: "#F4F1EA", letterSpacing: "-0.02em", lineHeight: 1.12, marginBottom: "1.25rem" }}>
            Audit-ready AI governance, for the price bracket <span style={{ fontStyle: "italic", color: "#E5484D" }}>enterprise tools ignore.</span>
          </h1>
          <p style={{ ...syne, fontSize: "14px", color: "rgba(255,255,255,0.5)", lineHeight: 1.7, maxWidth: "560px", margin: "0 auto" }}>
            Companies have zero way to prove AI governance when a regulator or board asks. EU AI Act enforcement starts August 2026. SEC is running 2026 exams testing exactly this. Everyone who already serves this charges £24,000–£790,000/year and only sells to enterprise.
          </p>
        </div>
      </section>
      ...
      <Section title="Why Now">
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {[
            ...
            ["FTC penalty per violation", "$53,088 — already enforced against Cox Media Group (~$1M, May 2026)"],
      ...
      <Section title="The Moat">
        <p style={{ ...syne, fontSize: "15px", color: "rgba(255,255,255,0.7)", lineHeight: 1.8 }}>
          Not a patent. Speed today; accumulated audit history and client relationships over time — once a client has months of evidence in the system, switching costs them their record right when a regulator might ask. Sentinel is white-glove: the founder works directly with clients, which doesn&apos;t scale infinitely but builds the kind of trust enterprise tools can&apos;t buy at this price point.
        </p>
      </Section>
