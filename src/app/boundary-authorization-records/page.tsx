  ...
  return (
    <div style={{ background: "#0A1628", minHeight: "100vh" }}>
      ...
      <Section eyebrow="The record" title="Every field, and why it exists">
        ...
        <Field name="expiry_conditions">The specific, observable conditions that void the grant early, written at the moment of signing, not added afterwards. &quot;Vendor X appears on a regulator&apos;s enforcement list&quot; is a condition. &quot;If things go wrong&quot; is not. Each one carries its own action: anyone who can view the record, not just the owner, can mark it observed the moment it becomes true. That pulls the expiry forward, never back, and seals as its own dated event.</Field>
