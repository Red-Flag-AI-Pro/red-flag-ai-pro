  ...
  return (
    <div style={{ background: "#0A1628", minHeight: "100vh" }}>
      ...
      <Section eyebrow="The record" title="Every field, and why it exists">
        ...
        <Field name="owner_confirmed_name / owner_confirmed_at">Optional. A seat named in a record nobody circulated is not accountability, it is a document produced later at a worse moment. This is the named owner&apos;s own confirmation, via a link only they can act on, that they actually know they hold it — separate from the account holder asserting owner_name on their behalf.</Field>
