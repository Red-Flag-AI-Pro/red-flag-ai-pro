          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-[rgba(229,72,77,0.3)] bg-gradient-to-br from-[rgba(229,72,77,0.08)] to-[#0A1628] p-5 flex flex-col justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-[rgba(244,241,234,0.5)]">Answer 12 questions about how your organisation owns and governs AI. Get a scored gap report across 6 dimensions in under 2 minutes.</p>
              </div>
              <Link
        ...
        <div className="rounded-xl border border-white/10 bg-gradient-to-r from-[#0A1628] to-[#0C1929] px-5 py-4 flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-[rgba(244,241,234,0.5)] mt-0.5">
              {plan === "free"
                ? `5 scans/month, all 30 risk categories, PDF reports. ${SCANNER_SALE_ACTIVE ? "£149/mo, founder's birthday sale until 31 Jul." : "£350/mo."}`
