...
const HOW_IT_WORKS = [
  ...
  { num: "03", title: "Earn every month", body: "You get 15% recurring commission on every payment. One Pro referral (£499/mo) pays ~£74.85/month. One Sentinel referral (custom, from £3,000+/mo) pays £450+/month. As long as they stay subscribed, you earn." },
];
...
const EARNINGS = [
  { referrals: 5, plan: "Pro (£499/mo)", monthly: "£374", annual: "£4,491" },
  { referrals: 10, plan: "Pro (£499/mo)", monthly: "£749", annual: "£8,982" },
    ...
    <div style={{ background: "#0A1628", minHeight: "100vh" }}>
      ...
      <section style={{ background: "#0C1929", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)", padding: "4rem 1.5rem" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "2px", textAlign: "center" }}>
          {[
            ...
            { value: "£74.85+", label: "Monthly per Pro referral", sub: "15% of £499/mo" },
      ...
      <section style={{ background: "#0D1B2E", padding: "7rem 1.5rem", borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <h2 style={{ ...syne, fontSize: "clamp(1.75rem, 4vw, 2.5rem)", fontWeight: 700, letterSpacing: "-0.02em", marginBottom: "4rem", textAlign: "center", background: "linear-gradient(160deg, #F4F1EA 0%, #F4F1EA 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Red Flag covers 9 jurisdictions</h2>
